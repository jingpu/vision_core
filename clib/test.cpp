...
int main(int argc, char* argv[])
{
  ...
  // Set tap values
  unsigned int tap_Green_to_Lum_0 = 0; 	// TODO change in value
  unsigned int tap_Blue_to_Lum_0 = 0; 	// TODO change in value
  unsigned int tap_Red_to_Lum_0 = 0; 	// TODO change in value
  unsigned int tap_G1_0 = 0; 	// TODO change in value
  unsigned int tap_G0_0 = 0; 	// TODO change in value
  unsigned int tap_G2_0 = 0; 	// TODO change in value
  unsigned int tap_G4_0 = 0; 	// TODO change in value
  unsigned int tap_G3_0 = 0; 	// TODO change in value
  unsigned int tap_R_0 = 0; 	// TODO change in value
  signed int tap_K_0 = 0; 	// TODO change in value
  signed int tap_Peak_0 = 0; 	// TODO change in value
  ...
  Resp_5(downCast_38_v, Resp_32_v
  	, tap_K_0
  );
  ...
  Image<int> cropSpecial0Node_10_ref(width, height, 3, 0);
